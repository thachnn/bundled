...
const hasRegexChars = str => REGEX_SPECIAL_CHARS.test(str);
const escapeRegex = str => str.replace(REGEX_SPECIAL_CHARS_GLOBAL, '\\$1');
const toPosixSlashes = str => str.replace(REGEX_BACKSLASH, '/');
...
const escapeLast = (input, char, lastIdx) => {
...
const removePrefix = (input, state = {}) => {
  let output = input;
...
const wrapOutput = (input, state = {}, options = {}) => {
