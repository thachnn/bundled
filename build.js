!(function (global, factory) {
	typeof exports == 'object' && typeof module != 'undefined' ? factory(exports, process) :
	typeof define == 'function' && define.amd ? define(['exports', 'process'], factory) :
	factory(((global = typeof globalThis != 'undefined' ? globalThis : global || self).VueTemplateCompiler = {}),
		global.process || { env: {} });
})(this, function (exports, process) {
'use strict';
 ...
 * Always return false.
 */
var no = function (a, b, _c) { return false; };
 ...
 */
function defineReactive(obj, key, val, customSetter, shallow, mock, _observeEvenIfShallow) {
...
function dependArray(value) {
    for (var e, i = 0, l = value.length; i < l; i++) {
        /**
         * @prop {Observer} __ob__
         * @prop {?boolean} __v_isRef
         * @prop {?boolean} __v_isReadonly
         * @prop {?boolean} __v_skip
         */
        e = value[i];
        if (e && e.__ob__) {
            e.__ob__.dep.depend();
...
/**
 * @prop {?Proxy} _renderProxy
 * @prop {?Object} _props
 * @prop {?Array} _propKeys
 * @prop {?boolean} _isVue
 * @prop {?string} cid
 * @prop {?boolean} _isDestroyed
 * @prop {?Object} _provided
 * @prop {?boolean} _hasHookEvent
 * @prop {?Proxy} _listenersProxy
 * @prop {?Proxy} _attrsProxy
 * @prop {?VNode} _vnode
 */
    ...
    generateComponentTrace = function (vm) {
        if (vm._isVue && vm.$parent) {
            ...
            return ('\n\nfound in\n\n' +
                tree
                    .map(function (vm, i) {
                    return '' + (i === 0 ? '---> ' : repeat_1(' ', 5 + i * 2)) + (isArray(vm)
...
function isBoolean(/* ...args */) {
    return Array.prototype.some.call(arguments, function (elem) { return elem.toLowerCase() === 'boolean'; });
}
...
function parseFilters(exp) {
    ...
    var c = void 0, prev, i, expression, filters = void 0;
    ...
    // 2.6 v-slot syntax
    {
        if (el.tag === 'template') {
            ...
            if (slotBinding) {
                ...
                var _a = getSlotName(slotBinding), dynamic_2 = _a.dynamic;
                el.slotTarget = _a.name;
                el.slotTargetDynamic = dynamic_2;
...
function markStatic(node) {
    ...
    if (node.type === 1) {
        ...
        if (node.ifConditions) {
            for (i = 1, l = node.ifConditions.length; i < l; i++) {
...
function genChildren(el, state, checkSkip, altGenElement, altGenNode) {
    ...
    if (children.length) {
        ...
        return ('[' + children.map(function (c) { return gen_1(c, state); }).join(',') + ']' +
