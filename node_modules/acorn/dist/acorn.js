!(function (global, factory) {
  ...
  factory((typeof globalThis != "undefined" ? globalThis : global || self).acorn = {});
...
pp.parseExportDeclaration = /** @param {*} [node] */ function(node) {
...
pp.parseAssignableListItem = /** @param {*} [allowModifiers] */ function(allowModifiers) {
...
pp.shouldParseArrow = /** @param {*} [exprList] */ function(exprList) {
...
pp.validateRegExpPattern = function(state) {
  ...
  // parsing contains a |GroupName|, re-parse with the goal symbol
