module.exports = (function (modules) {
  ...
  function __webpack_require__(moduleId) {
    ...
    installedModules[moduleId] = module = { exports: {}, id: moduleId, loaded: false };
...
var base64VLQ = __webpack_require__(2),
  ...
  ArraySet = __webpack_require__(5).ArraySet,
  MappingList = __webpack_require__(6).MappingList;
...
exports.decode = function (charCode) {
  ...
  return bigA <= charCode && charCode <= 90
    ? charCode - bigA
    : littleA <= charCode && charCode <= 122
    ? charCode - littleA + 26
    : zero <= charCode && charCode <= 57
    ? charCode - zero + 52
    : charCode == 43
    ? 62
    : charCode == 47
...
function normalize(aPath) {
  ...
  for (var part, up = 0, i = parts.length - 1; i >= 0; i--)
    if ((part = parts[i]) === '.') parts.splice(i, 1);
    else if (part === '..') up++;
    else if (up > 0)
      if (part === '') {
        parts.splice(i + 1, up);
  ...
  if ((path = parts.join('/')) === '') path = isAbsolute ? '/' : '.';
...
var util = __webpack_require__(4),
  binarySearch = __webpack_require__(8),
  ArraySet = __webpack_require__(5).ArraySet,
  base64VLQ = __webpack_require__(2),
...
BasicSourceMapConsumer.fromSourceMap = function (aSourceMap, aSourceMapURL) {
  var smc = Object.create(BasicSourceMapConsumer.prototype),
    ...
    names = (smc._names = ArraySet.fromArray(aSourceMap._names.toArray(), true)),
    sources = (smc._sources = ArraySet.fromArray(aSourceMap._sources.toArray(), true));
...
BasicSourceMapConsumer.prototype._parseMappings = function (aStr, aSourceRoot) {
  ...
  while (index < length)
    if (aStr.charAt(index) === ';') {
      ...
      (mapping = new Mapping()).generatedLine = generatedLine;
      ...
      typeof mapping.originalLine != 'number' || originalMappings.push(mapping);
    }
...
IndexedSourceMapConsumer.prototype._parseMappings = function (aStr, aSourceRoot) {
  ...
  for (var i = 0; i < this._sections.length; i++) {
    var section = this._sections[i],
      sectionMappings = section.consumer._generatedMappings;
...
function recursiveSearch(aLow, aHigh, aNeedle, aHaystack, aCompare, aBias) {
  var mid = Math.floor((aHigh - aLow) / 2) + aLow,
    cmp = aCompare(aNeedle, aHaystack[mid], true);
  return cmp === 0
    ? mid
    : cmp > 0
    ? aHigh - mid > 1
      ...
      ? aHigh < aHaystack.length ? aHigh : -1
      : mid
    : mid - aLow > 1
...
exports.search = function (aNeedle, aHaystack, aCompare, aBias) {
  ...
  while (index - 1 >= 0 && aCompare(aHaystack[index], aHaystack[index - 1], true) === 0) --index;
  ...
  var shiftNextLine = function () {
    ...
    function getNextLine() {
      return remainingLinesIndex < remainingLines.length
        ? remainingLines[remainingLinesIndex++] : void 0;
    }
  };
