...
var util = __webpack_require__(0),
  ...
  Readable = __webpack_require__(4),
  Writable = __webpack_require__(6);
...
var StringDecoder,
  BufferList = __webpack_require__(10),
  destroyImpl = __webpack_require__(5);
...
function ReadableState(options, stream) {
  ...
  this.encoding = null;
  if (options.encoding) {
    StringDecoder || (StringDecoder = __webpack_require__(7).StringDecoder);
...
Writable.prototype.setDefaultEncoding = function (encoding) {
  ...
  if (['hex', 'utf8', 'utf-8', 'ascii', 'binary', 'base64', 'ucs2', 'ucs-2',
      'utf16le', 'utf-16le', 'raw'].indexOf((encoding + '').toLowerCase()) < 0)
...
function doWrite(stream, state, writev, len, chunk, encoding, cb) {
  ...
  state.writing = true;
  state.sync = true;
  writev ? stream._writev(chunk, state.onwrite)
...
__webpack_require__(0).inherits(Transform, Duplex);
...
if (process.env.READABLE_STREAM === 'disable' && Stream) {
  ...
  (exports = module.exports = __webpack_require__(4)).Stream = Stream || exports;
  exports.Readable = exports;
  exports.Writable = __webpack_require__(6);
  exports.Duplex = __webpack_require__(1);
  exports.Transform = __webpack_require__(8);
  exports.PassThrough = __webpack_require__(11);
}
...
__webpack_require__(0).inherits(PassThrough, Transform);
